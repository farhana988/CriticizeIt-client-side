...
function ErrorPage() {
  return (
    ...
    >
      {/* lottie image */}
      <div className="w-60 md:w-80 lg:w-[600px] absolute z-20
      top-40 -left-9
      md:left-6 md:top-24
     ...
     px-10 md:px-28 lg:px-0"
      >
        <div className="text-center py-16 md:py-20 lg:py-32 
        ...
        max-w-5xl w-full animate__animated animate__fadeIn animate__delay-0.1s ">
          ...
          <p className="text-xs md:text-base lg:text-xl mb-6 opacity-80 animate__animated animate__fadeIn
           animate__delay-2s text-gray-900">
            seems like you have lost that page in the digital void
          </p>

          <div className="flex justify-center items-center gap-8 animate__animated 
          animate__fadeIn animate__delay-3s">
            <h2 className="md:text-xl lg:text-3xl font-semibold opacity-90
             text-gray-500 flex 
            items-center gap-4">
