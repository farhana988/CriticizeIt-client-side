...
const Login = () => {
  ...
  return (
    <div>
      <h2
        className="text-3xl md:text-5xl font-bold mb-14 text-primary 
        dark:text-ivory
          active text-center
       "
      >
      ...
      <div className="hero flex flex-col md:flex-row lg:flex-row justify-center">
        ...
        <div className="hero-content flex-col ">
          <div
            className="card bg-lCard dark:bg-dCard w-full max-w-5xl 
          shrink-0 shadow-md shadow-primary"
          >
            <form
            ...
            >
             ...
             hover:from-primary hover:to-primary font-semibold 
              ...
              <h2 className="text-sm mt-3 flex items-center gap-2">
                ...
                <Link to="/register">
                  <span
                   ...
                   text-primary dark:text-ivory active text-base font-extrabold"
                  >
                    <FaLongArrowAltRight />
                    Register
                  </span>
